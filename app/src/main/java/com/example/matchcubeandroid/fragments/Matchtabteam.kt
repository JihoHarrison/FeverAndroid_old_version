...
class Matchtabteam : Fragment() {
    ...
    override fun onCreateView(
        ...
        val teamId: Long = 1;
        var  i: Int = 0
        var teamsLists = ArrayList<ProfileModel>()
                    ...
                    floatingBtn.visibility = View.INVISIBLE
                        ...
                        for(i in i until dataSize) {
                            teamsLists.apply {
                                ...
                                add(ProfileModel(R.drawable.baseline_people_black_24, response.body()!!.data?.get(i)?.teamName.toString()
                                ))
                            }
                        }
...
//                        add(ProfileModel(R.drawable.baseline_people_black_24, "hello3"))
                    ...
                    myTeamsRc.adapter = ProfileAdapter(teamsLists)
                }
            }
